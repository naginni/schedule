...
class Crossing
   ...
   def self.crossingType(indiv1, indiv2)
   ...
   # realizando cruce uniforme
	def self.crossingUniform(father, mother)
		# obtengo la longitud de mi individuo
	...
	def self.crossingPMX(father, mother)
		# obtengo la longitud de mi individuo
		length = father.length
   ...
   # se realiza la busquedad secuencial
	def self.busquedadSecuencial(gene, children)
		position = -1
		i = 0
